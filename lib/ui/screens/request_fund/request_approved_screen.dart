      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(AssetsImages.deal),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            Text(
              'Your request for a deposit has been approved and the fund has been deposited into your wallet balance.',
              textAlign: TextAlign.center,
            ...
            Row(
              ...
              children: [
                Text(
                  '*',
                  style: sizeFourteenLightBlack.copyWith(color: Colors.red),
                ),
                Expanded(
                    child: Text(
                  'Funds will automatically be deducted from your bank account if not refunded before the due date',
                  style: sizeFourteenLightBlack,
                  textAlign: TextAlign.center,
                )),
              ],
            ),
