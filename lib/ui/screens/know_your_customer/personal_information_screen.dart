...
import 'package:sanlater/ui/screens/know_your_customer/proof_of_identity_screen.dart';
          ...
          children: [
            ...
            multiplyingFactor: 1,
              onPressed: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context)=>ProofOfIdentity()));
              },
